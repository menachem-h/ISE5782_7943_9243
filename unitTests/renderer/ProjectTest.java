...
public class ProjectTest {
    ...
    public void imageTest01() {
        ...
        List<LightSource> lights = new LinkedList<>();
        //lights.add(new SpotLight(new Color(255, 197, 143), new Point(145, 300, 150), new Vector(-1, -2, 0)).setkL(0.0004).setkQ(0.0000006));
        lights.add(new SpotLight(new Color(WHITE), new Point(25, 230, 950), new Vector(-0.2, -0.1, -0.5).normalize()).setkL(0.0004).setkQ(0.0000006));

        Polygon rightWall = (Polygon) new Polygon(new Point(-250, -50, 200), new Point(-250, 450, 200),
                new Point(-250, 450, 1000), new Point(-250, -50, 1000)).setEmission(new Color(GRAY));
        ...
        FloorSquare floor = new FloorSquare(new Point(-250, -50, 200), Vector.Z_AXIS, Vector.X_AXIS, new Color(218, 160, 109), new Color(111, 78, 55), 1200, 500, 36, 30);
        ...
        Chair frontChair = new Chair(new Point(-8, 0, 880), 45d, 100d, 6d, 5d, 3d, 0.75d,
                ...
                .setSeatMaterial(new Material().setkD(0.7).setkS(0.05))
                .setSeatCoverEmission(new Color(108, 122, 134)).setBrCoverEmission(new Color(108, 122, 134));
        Chair cornerChairFlipped = new Chair(new Point(-215, 0, 240), 45d, 100d, 6d, 5d, 3d, 0.75d,
                new Vector(1, 0, 0), new Vector(0, 0, 1), new Color(186, 164, 138), true)
                .setSeatMaterial(new Material().setkD(0.7).setkS(0.05));
        ...
        Chair cornerChairFlipped1 = new Chair(new Point(-215, 0, 330), 45d, 100d, 6d, 5d, 3d, 0.75d,
                Vector.X_AXIS, Vector.Z_AXIS, new Color(186, 164, 138), false)
                .setSeatMaterial(new Material().setkD(0.7).setkS(0.05));
        Chair cornerChair1 = new Chair(new Point(-210, -0.1, 330), 45d, 100d, 6d, 5d, 3d, 0.75d,
                new Vector(-1, 0, 0), new Vector(0, 0, -1), new Color(186, 164, 138), false)
                .setSeatMaterial(new Material().setkD(0.7).setkS(0.05));
        Table table = new Table(75, 95d, new Color(193, 154, 107), new Point(-8, -50, 800), new Vector(0, 1, 0), new Vector(1, 0, -1))
                .setMaterialSurfaceTop(new Material().setkS(0.05).setkD(0.1).setkR(0.15)).setColorBars(new Color(186, 135, 89));
